...
<head>
    ...
    <title>Register - Admin Karyawan</title>
</head>
        ...
        <div class="login-box register">
            <form class="login-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="password-confirm" type="password" placeholder="Password Confirm"
                        name="password_confirmation" required>
                </div>

                <div class="form-group btn-container">

                    <p class="semibold-text">already have an account?<a href="{{ route('login') }}"> Login</a></p>
